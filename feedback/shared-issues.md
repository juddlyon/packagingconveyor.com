...
- ~~Homepage pallet link resolving incorrectly~~ Fixed: now uses absolute path.
- ~~No internal-link integrity check~~ Addressed: `internal-linker` CLI tool used for auditing. Consider adding to CI.
